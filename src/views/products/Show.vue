    ...
    getProduct(id){
      this.axios.get(`http://127.0.0.1:8000/api/products/${this.$route.params.id}`)
          .then(res => {
            ...
            this.product_img_1 = this.product.product_images[0].url;
            this.product_img_2 = this.product.product_images[1].url;
            console.log(this.product_img_1);
            ...
            <div class="col-xl-6 col-lg-6 mt-30 wow fadeInUp animated">
              <div class="single-product-box one">
                <div class="big-product single-product-one slider-for">
                  <div>
                    <div class="single-item"> <img :src="product.image_url" alt="">
                  ...
                  <div>
                    <div class="single-item"> <img :src="product_img_1" alt="">
                      <div class="ptag"> <span class="one">-20% </span> </div>
                      <a href="#0" class="love">
                        <i class="flaticon-like"></i>
                      </a>
                  ...
                  <div>
                    <div class="single-item"> <img :src="product_img_2" alt="">
                      <div class="ptag"> <span class="one">-20% </span> </div>
                      <a href="#0" class="love">
                        <i class="flaticon-like"></i>
                      </a>
                ...
                <div class="navholder">
                  <div class="product-slicknav single-product-one-nav slider-nav">
                    <div>
                      <span class="single-item"> <img :src="product.image_url" alt=""> </span>
                    </div>
                    <div>
                      <span class="single-item"> <img :src="product_img_1" alt=""> </span>
                    </div>
                    <div>
                      <span class="single-item"> <img :src="product_img_2" alt=""> </span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="shop-details-top-right ">
                <div class="shop-details-top-right-content-box">
                  ...
                  <div class="shop-details-top-price-box">
                    <h3>${{this.product.price}}<del>${{this.product.price+this.product.price/10}}</del></h3>
                    <p>(+15% Vat Included)</p>
                  </div>
            ...
            <div class="catagory-slider">
              ...
              <div class="products-grid-one">
                <div class="products-grid-one__product-image">
                  <div class="products-grid-one__badge-box"> <span
                    ...
                    src="@/assets/images/shop/products-img3.jpg" alt="Alt"> <img
                    class="products-grid-one__hover-img" src="@/assets/images/shop/products-img4.jpg"
                    alt="Alt"> </a>
                  <div class="products-grid__usefull-links">
                    <ul>
                      <li><a href="wishlist.html"> <i class="flaticon-heart"> </i> <span>
              ...
              <div class="products-grid-one">
                <div class="products-grid-one__product-image">
                  <div class="products-grid-one__badge-box"> <span class="bg_base badge new ">New</span>
                    ...
                    class="products-grid-one__hover-img" src="@/assets/images/shop/products-img5.jpg"
                    alt="Alt"> </a>
                  <div class="products-grid__usefull-links">
                    <ul>
                      <li><a href="wishlist.html"> <i class="flaticon-heart"> </i> <span>
              ...
              <div class="products-grid-one">
                <div class="products-grid-one__product-image">
                  <div class="products-grid-one__badge-box"> <span class="bg_base badge new ">New</span>
                    ...
                    class="products-grid-one__hover-img" src="@/assets/images/shop/products-img2.jpg"
                    alt="Alt"> </a>
                  <div class="products-grid__usefull-links">
                    <ul>
                      <li><a href="wishlist.html"> <i class="flaticon-heart"> </i> <span>
              ...
              <div class="products-grid-one">
                <div class="products-grid-one__product-image"> <a href="shop-details-1.html"
                    ...
                    class="products-grid-one__hover-img" src="@/assets/images/shop/products-img11.jpg"
                    alt="Alt"> </a>
                  <div class="products-grid__usefull-links">
                    <ul>
                      <li><a href="wishlist.html"> <i class="flaticon-heart"> </i> <span>
